...
import="models.layanan"%> <%@page import="models.Customer"%> <% layanan
layananData = (layanan) request.getAttribute("layanan"); if (layananData ==
null) { response.sendRedirect("order?menu=view"); return; } %>
<!DOCTYPE html>
<html lang="id">
  <head>
              ...
              >
                ...
                <div class="mb-3">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    value="<%= layananData.getDeskripsi() %>"
                    disabled
                  />
                </div>
