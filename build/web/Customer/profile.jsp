<%@page import="models.Customer"%> <%@page contentType="text/html"
pageEncoding="UTF-8"%> <% HttpSession userSession = request.getSession(false);
if (userSession == null || userSession.getAttribute("user") == null) {
response.sendRedirect("../index.jsp"); return; } Customer customer = (Customer)
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 content">
          <div class="container my-5">
            ...
            <div class="mb-4">
              <form
                id="deleteAccount"
                action="<%= request.getContextPath() %>/customerr?action=deleteAccount"
                method="POST"
              >
                ...
                <a
                  ...
                  href="<%= request.getContextPath() %>/customerr/editProfile"
                  role="button"
                  >Edit Profile</a
                >
                <button
            ...
            <div class="balance-card">
              ...
              <h3 class="text-success">
                Rp <%= String.format("%,.0f", customer.getSaldo()) %>
              </h3>
              <a
                class="nav-link btn btn-primary w-100"
                href="<%= request.getContextPath() %>/customerr/addSaldo"
                >Isi Saldo</a
              >
            </div>
