...
response.sendRedirect("../index.jsp"); return; } ArrayList<layanan>
          ...
          <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 content">
              <div class="container my-5">
                ...
                <div class="row">
                  <% if (layanans != null && !layanans.isEmpty()) { for (layanan
                  layanan : layanans) { %>
                  <div class="col-md-4 mb-4">
                    <div class="card h-100">
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          <strong
                            >Harga: Rp <%= String.format("%,d",
                            (int)layanan.getPrice()) %></strong
                          >
                        </p>
                        <p class="card-text">
                          <strong
                            >Durasi: <%= String.format("%,d",
                            layanan.getDurasi()) %></strong
                          >
                        </p>
                        <a
                          href="<%= request.getContextPath() %>/order?menu=create&serviceId=<%= layanan.getId() %>"
